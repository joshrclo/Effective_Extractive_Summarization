...
1. path to RELEASE-1.5.5 (evaluate.py line 14), example: `/home/ROUGE/RELEASE-1.5.5` // Use ROUGE from https://github.com/joshrclo/evaluation/tree/master/ROUGE-RELEASE-1.5.5
